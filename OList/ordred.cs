...
namespace LinkedList
{
    class OrderedList
    {
        public void Ordered()
        {
            ...
            string text = File.ReadAllText(@"C:\Users\Srinidhi\source\repos\LinkedList\LinkedList\bin\Debug\netcoreapp3.1\input.txt", Encoding.UTF8);
            ...
            File.WriteAllText(@"C:\Users\Srinidhi\source\repos\LinkedList\LinkedList\bin\Debug\netcoreapp3.1\input.txt", intString);
        }
    }
}
